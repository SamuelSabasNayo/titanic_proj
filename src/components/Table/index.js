        ...
        <TableContainer component={Paper} style={{ width: '80%', margin: 'auto', marginTop: 30 }}>
            <Table className={classes.table} aria-label="customized table">
                <TableHead  style={{ background: '#4051B6' }}>
                    <TableRow>
                        <StyledTableCell>Survived People</StyledTableCell>
                        <StyledTableCell align="right">Male Survived</StyledTableCell>
                        <StyledTableCell align="right">Female Survived</StyledTableCell>
